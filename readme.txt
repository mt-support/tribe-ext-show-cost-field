=== Event Tickets/Eventbrite Extension: Show Cost Field ===
...
Force displaying The Events Calendar's "Event Cost" field in wp-admin and the Community Events event edit form (if applicable) when Event Tickets or Eventbrite Tickets is activated.
